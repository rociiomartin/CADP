...
Una compañía de telefonía celular dispone de una estructura de datos con información de todas las facturas emitidas durante los
años 2019 y 2020 para sus 3400 clientes. De cada factura se conoce el mes (1 a 12), el año (2019 6 2020), el código del cliente y
el monto facturado. La información se encuentra ordenada por código del cliente.

a.Realizar un módulo que retorne en una estructura de datos la información de los clientes. De cada cliente se conoce su código
