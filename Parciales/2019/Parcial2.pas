...
Un comercio de la ciudad de La Plata necesita un programa para administrar información de las ventas realizadas durante 2019. 
Para ello, se debe:

A) Leer y almacenar la información de las ventas. De cada venta se lee: código, fecha (día y mes), DNI del cliente y monto. La 
lectura de información finaliza cuando se lee el DNI -1 (que no debe procesarse). La información debe quedar almacenada de 
manera ordenada por DNI del cliente. Tener en cuenta que cada cliente puede aparecer en una o más ventas.
...
3. Porcentaje de ventas realizadas entre Febrero y Septiembre y con código compuesto por la misma cantidad de dígitos pares que
impares.
