...
Procedure Informar(var cantLP,cue1,cue2:integer; nom1,nom2:cadena20); 
...
var 
    ...
    cantLP, cue1,cue2 :integer; 

    nom1,nom2:candena20; 

begin 

   cantLP:=0; nom1:=''; nom2:=''; cue1:=-1; cue2:=-1; 

   Informar(cantLP,cue1,cue2,nom1,nom2); 
